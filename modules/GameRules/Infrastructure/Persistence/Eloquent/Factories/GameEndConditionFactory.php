...
/**
 * @extends Factory<GameEndCondition>
 */
class GameEndConditionFactory extends Factory
{
    /**
     * The model the factory builds.
     *
     * @var class-string<GameEndCondition>
     */
    protected $model = GameEndCondition::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'name' => 'The deck runs out '.fake()->unique()->numberBetween(1, 9999),

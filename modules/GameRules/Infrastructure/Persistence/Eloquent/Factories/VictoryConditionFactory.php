...
/**
 * @extends Factory<VictoryCondition>
 */
class VictoryConditionFactory extends Factory
{
    /**
     * The model the factory builds.
     *
     * @var class-string<VictoryCondition>
     */
    protected $model = VictoryCondition::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'name' => 'First to twenty points '.fake()->unique()->numberBetween(1, 9999),

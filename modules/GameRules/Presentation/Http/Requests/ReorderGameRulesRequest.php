...
/**
 * Putting a rule set's rules into the order the designer dragged them into.
 *
 ...
 */
class ReorderGameRulesRequest extends RuleSetRequest
{
    ...
    {
        return $this->orderRules('rule_ids');
    }
    ...
    {
        /** @var list<string> $ids */
        $ids = array_values($this->validated('rule_ids', []));

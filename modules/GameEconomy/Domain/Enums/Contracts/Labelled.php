 ...
 *
 * Every vocabulary in this module words itself, so that a category renamed in
 * the domain reads the new way in the interface without anything in TypeScript

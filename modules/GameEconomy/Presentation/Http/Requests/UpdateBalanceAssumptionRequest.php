...
class UpdateBalanceAssumptionRequest extends BalanceRequest
{
     ...
     *
     * Every field optional, because raising or lowering confidence on its own is
     * the commonest edit this endpoint sees.
     *
    ...
    {
        return [
            'title' => $this->assumptionTitleRules(required: false),

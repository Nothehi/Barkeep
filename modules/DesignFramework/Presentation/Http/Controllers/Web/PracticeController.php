...
use Inertia\Inertia;
use Modules\DesignFramework\Application\Commands\CreatePractice;
use Modules\DesignFramework\Application\Commands\ReorderPractice;
use Modules\DesignFramework\Application\Commands\UpdatePractice;
...
use Modules\DesignFramework\Presentation\Http\Requests\Content\CreatePracticeRequest;
use Modules\DesignFramework\Presentation\Http\Requests\Content\UpdatePracticeRequest;
use Modules\DesignFramework\Presentation\Http\Requests\ReorderRequest;

/**
 * The framework builder's activities.
 *
...
class PracticeController extends Controller
{
    ...
    public function update(
        ...
        UpdatePractice $update,
    ): RedirectResponse {
        $update->handle($request->user(), $practice, $request->toData());
    ...
    public function reorder(
        ...
        FrameworkVersion $version,
        DesignPractice $practice,
        ReorderPractice $reorder,
    ): RedirectResponse {
        $reorder->handle($request->user(), $practice, $request->position());

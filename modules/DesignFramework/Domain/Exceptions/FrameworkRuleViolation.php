...
/**
 * A design framework invariant was violated.
 *
 ...
 * `DesignFrameworkServiceProvider::configureExceptionRendering()`; it is named
 * here in prose rather than in a `@see` tag so the domain keeps no import
 * pointing back up at the layers above it.
 */
abstract class FrameworkRuleViolation extends DomainException
{
    /**

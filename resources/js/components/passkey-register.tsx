...
export default function PasskeyRegistration({ onSuccess }: Props) {
    ...
    const [name, setName] = useState(() => {
        ...
        /**
         * A device name, not a sentence: it is the default the reader is
         * about to edit, so it is built from the two proper nouns with a
         * translated joining word between them.
         */
        return browser && os
            ? t(':browser on :os', { browser, os })
            : (browser ?? os ?? '');
    });

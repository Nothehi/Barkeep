...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {/*
        * The icon is a panel with a chevron pointing at the sidebar, so it has
        * to be mirrored when the sidebar moves to the other edge. Rotating it
        * rather than swapping to the `PanelRight*` pair keeps the panel on the
        * correct side too.
        */}
      <span className={direction === "rtl" ? "rotate-180" : undefined}>

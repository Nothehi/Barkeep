...
/**
 * Radix does not read `dir` off the document, so it is handed the active
 * direction here. Without it a menu in a right-to-left page still opens its
 * submenus to the right and reads its arrow keys the wrong way round.
 */

...
/**
 * Handed the active direction for the same reason the dropdown menu is:
 * Radix defaults to left-to-right unless told otherwise.
 */
function Select({
  dir,
  ...props
  ...
  return (
    <SelectPrimitive.Root data-slot="select" dir={dir ?? direction} {...props} />
  )
}

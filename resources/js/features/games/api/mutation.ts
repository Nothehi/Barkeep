...
/**
 * The shared options every game mutation accepts.
 *
 * Game mutations are Inertia visits rather than JSON calls. The server
...
export type MutationOptions = {
    ...
    /**
     * Keep the scroll position. Worth setting for a lifecycle action pressed
     * from halfway down a long game screen.
     */
